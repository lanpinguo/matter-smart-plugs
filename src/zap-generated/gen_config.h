...
#define EMBER_AF_IDENTIFY_CLUSTER_SERVER_ENDPOINT_COUNT (8)
#define EMBER_AF_GROUPS_CLUSTER_SERVER_ENDPOINT_COUNT (8)
#define EMBER_AF_SCENES_CLUSTER_SERVER_ENDPOINT_COUNT (8)
#define EMBER_AF_ON_OFF_CLUSTER_SERVER_ENDPOINT_COUNT (8)
#define EMBER_AF_LEVEL_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define EMBER_AF_DESCRIPTOR_CLUSTER_SERVER_ENDPOINT_COUNT (9)
